...
CREATE TABLE `zebra`.`accounts` (
  ...
  `age` bigint(64) UNSIGNED NOT NULL COMMENT "年龄",
  `age_id` bigint(64) UNSIGNED NOT NULL COMMENT "年龄 id",
  `email` varchar(128) NOT NULL COMMENT "邮箱",
  `email_id` bigint(64) UNSIGNED NOT NULL COMMENT "邮箱 id",
  `bank` bigint(64) UNSIGNED NOT NULL COMMENT "银行账户余额,$",
  `bank_id` bigint(64) UNSIGNED NOT NULL COMMENT "银行账户余额 id",
  `cellphone` bigint(64) UNSIGNED DEFAULT NULL COMMENT '手机号',
  `cellphone_id` bigint(64) UNSIGNED DEFAULT NULL COMMENT '手机号 id',
...
CREATE TABLE `zebra`.`ages` (
  ...
  `age` bigint(64) UNSIGNED NOT NULL COMMENT '类别',
...
CREATE TABLE `zebra`.`banks` (
  `id` bigint(64) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `bank` bigint(64) UNSIGNED NOT NULL COMMENT 'money count,$',
  `is_deleted` TINYINT(4) NOT NULL DEFAULT 0 COMMENT '删除标志,0:正常,1:删除',
  `created_at` DATETIME NOT NULL COMMENT '创建时间',
  `updated_at` DATETIME NOT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `zebra`.`cellphones` (
  `id` bigint(64) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `cellphone` bigint(64) UNSIGNED NOT NULL COMMENT '手机号',
  `is_deleted` TINYINT(4) NOT NULL DEFAULT 0 COMMENT '删除标志,0:正常,1:删除',
  `created_at` DATETIME NOT NULL COMMENT '创建时间',
  `updated_at` DATETIME NOT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`),
